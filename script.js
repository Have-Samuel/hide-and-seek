...
const closeB = popupWindow.querySelector();
...
// localStorage
const input1 = document.getElementById('signup');
const input2 = document.getElementById('fillup');
const input3 = document.getElementById('textup');
...
form.addEventListener('change', () => {
  ...
  data.textarea = input3.value;
  const myData = JSON.stringify(data);
  localStorage.setItem('input', myData);
});

const retrive = JSON.parse(localStorage.getItem('input'));
input1.value = retrive.name;
input2.value = retrive.email;
input3.value = retrive.textarea;
